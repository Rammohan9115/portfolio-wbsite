    ...
    <section ref={ref} id="contact" className='mb-20 sm:mb-28 w-[min(100%,38rem)] text-center '>
        ...
        <form action={async (formData) => {
          ...
          toast.success("Email sent successfully!");
            ...
            <input name="senderEmail" className="h-14 px-4 rounded-lg border border-black/10 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none " type="email" placeholder='your email' required maxLength={500}/>
            <textarea name="message" className='h-52 my-3 rounded-lg border border-black/10 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none' placeholder='Your Message' required maxLength={500}/>
            <button type="submit"
